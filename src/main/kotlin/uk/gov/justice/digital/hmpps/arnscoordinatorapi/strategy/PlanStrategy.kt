...
class PlanStrategy(
  ...
  override fun reset(resetData: ResetData, entityUuid: UUID): OperationResult<VersionedEntity> = OperationResult.Failure("Reset is not applicable for Plan entities")
}
